<cfcomponent>
	<cfscript>
		this.name = "pmpmgdev1 - Design Template";
...
<!--- =========================================================================================================================================== --->
	<cffunction name="onApplicationStart" output="false">
		...
		<cfset application.datasourcenh = "nursinghome">
		<cfset application.imgdir="images">
		<cfset application.apnhstateabbr = "nc">
		<cfset application.apnhstate = "north carlina">
...
<!--- =========================================================================================================================================== --->
	<cffunction name="onSessionStart" returntype="void" output="false">
		...
		<cfparam name="session.google" default="Direct">
		...
		<cfparam name="session.mailsent" default="0">
